...
class mobilAP_db
{
  ...
  md5 char(32) DEFAULT NULL,directory_active tinyint(1) NOT NULL DEFAULT '-1', admin tinyint(1) NOT NULL DEFAULT '0', organization char(50) DEFAULT NULL, PRIMARY KEY (userID),UNIQUE (email))",
            ...
            'session_evaluations'=>sprintf("CREATE TABLE IF NOT EXISTS session_evaluations (evaluation_id INTEGER PRIMARY KEY %s,session_id int(11) DEFAULT NULL,post_user char(32) DEFAULT NULL,post_timestamp int(11) DEFAULT NULL,q0 tinyint(4)  DEFAULT NULL,q1 tinyint(4)  DEFAULT NULL)", $this->_autoincrement()),
