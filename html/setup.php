...
$create_tables = array(
	...
	"CREATE TABLE IF NOT EXISTS `evaluation_question_responses` (`question_index` tinyint(4) unsigned NOT NULL default '0', `response_index` tinyint(4) unsigned NOT NULL default '0', `response_text` varchar(50) default NULL, PRIMARY KEY  (`question_index`,`response_index`))",
