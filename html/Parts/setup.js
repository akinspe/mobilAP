...
var dashcodePartSpecs = {
    ...
    "evaluation0_label": { "creationFunction": "CreateText", "text": "1. Value of Session" },
    "evaluation0_response": { "creationFunction": "CreateText", "text": "Item" },
    "evaluation0_responses": { "creationFunction": "CreateList", "dataArray": ["Item 1", "Item 2", "Item 3"], "dataSourceName": "session_evaluation", "labelElementId": "evaluation0_response", "listStyle": "List.ROUNDED_RECTANGLE", "sampleRows": 3, "useDataSource": true },
    "evaluation1_label": { "creationFunction": "CreateText", "text": "2. Relevance of Information Presented" },
    "evaluation1_response": { "creationFunction": "CreateText", "text": "Item" },
    "evaluation1_responses": { "creationFunction": "CreateList", "dataArray": ["Item 1", "Item 2", "Item 3"], "dataSourceName": "session_evaluation", "labelElementId": "evaluation1_response", "listStyle": "List.ROUNDED_RECTANGLE", "sampleRows": 4, "useDataSource": true },
    "evaluation2_label": { "creationFunction": "CreateText", "text": "3. Effectiveness of Presenters" },
    "evaluation2_response": { "creationFunction": "CreateText", "text": "Item" },
    "evaluation2_responses": { "creationFunction": "CreateList", "dataArray": ["Item 1", "Item 2", "Item 3"], "dataSourceName": "session_evaluation", "labelElementId": "evaluation2_response", "listStyle": "List.ROUNDED_RECTANGLE", "sampleRows": 4, "useDataSource": true },
    "evaluation3_label": { "creationFunction": "CreateText", "text": "4. From what I learned in this session I will make changes in my work / department / institution" },
    "evaluation3_response": { "creationFunction": "CreateText", "text": "Item" },
    "evaluation3_responses": { "creationFunction": "CreateList", "dataArray": ["Item 1", "Item 2", "Item 3"], "dataSourceName": "session_evaluation", "labelElementId": "evaluation3_response", "listStyle": "List.ROUNDED_RECTANGLE", "sampleRows": 4, "useDataSource": true },
    "evaluation4_label": { "creationFunction": "CreateText", "text": "5.  Other Comments" },
    ...
    "homeList": { "creationFunction": "CreateList", "dataSourceName": "browserController", "labelElementId": "listTitle", "listStyle": "List.EDGE_TO_EDGE", "sampleRows": 6, "useDataSource": true },
    ...
    "stackLayout": { "creationFunction": "CreateStackLayout", "subviewsTransitions": [{ "direction": "right-left", "duration": "", "timing": "ease-in-out", "type": "push" }, { "direction": "right-left", "duration": "", "timing": "ease-in-out", "type": "push" }, { "direction": "right-left", "duration": "", "timing": "ease-in-out", "type": "push" }, { "direction": "right-left", "duration": "", "timing": "ease-in-out", "type": "push" }, { "direction": "right-left", "duration": "", "timing": "ease-in-out", "type": "push" }, { "direction": "right-left", "duration": "", "timing": "ease-in-out", "type": "push" }, { "direction": "right-left", "duration": "", "timing": "ease-in-out", "type": "push" }, { "direction": "right-left", "duration": "", "timing": "ease-in-out", "type": "push" }, { "direction": "right-left", "duration": "", "timing": "ease-in-out", "type": "push" }] },
