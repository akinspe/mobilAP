...
?>
<li id="login_status"><?= $App->getUserID() ?> logged in <a href="login.php?action=logout">logout</a><?php if ($show_admin) { ?> | <a href="admin.php">admin</a><?php } ?></li>
<?php } else { ?>
<li id="login_status"><a href="login.php">Login</a></li>
<?php } ?>
</ul>
